...
var sInt = 4
var anInt = 20
swapTwoValues(&sInt, &anInt)
print("sInt is now \(sInt),anInt is now \(anInt)")

var someString = "hello"

var anotherStr = "world"

swapTwoValues(&someString, &anotherStr)
print("someString is now \(someString),anotherStr is now \(anotherStr)")
...
print("items is \(stackOfString.items)")
...
func findIndexOfString(ofString valueToFind: String,in array:[String]) ->Int?{
...
if let foundIndex = findIndexOfString(ofString: "llama", in: strings) {
    print("The idnex of llama is \(foundIndex)")
}
...
stackOfStrings.append("5")
stackOfStrings.append("6")
stackOfStrings.append("7")
var arrayOfStrings = ["5", "6", "7"]
